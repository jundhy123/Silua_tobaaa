...
<div class="max-w-4xl mx-auto space-y-10 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
            <h1 class="text-4xl font-black italic text-gray-900" style="font-family: 'Playfair Display', serif;">Tulis <span class="text-primary-orange">Kisah Baru</span></h1>
            <p class="text-gray-400 text-sm mt-1 italic">Tambahkan bab narasi baru untuk sejarah dan filosofi brand.</p>
        </div>
        ...
        <form action="{{ route('admin.about.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" required placeholder="cth. Warisan Resep" class="form-input font-bold italic">
                </div>
                <div class="space-y-2">
                    <label class="form-label">Sub-Headline Bab</label>
                    <input type="text" name="subtitle" placeholder="cth. Sejak Generasi Pertama" class="form-input font-bold">
                </div>
            </div>

            <div class="space-y-2">
                <label class="form-label">Narasi Utama</label>
                <textarea name="description" rows="6" placeholder="Ceritakan bab ini secara mendalam..." required class="form-input resize-none leading-relaxed"></textarea>
            </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="image-upload-box group" onclick="document.getElementById('imgInput').click()">
                        ...
                        <div id="placeholder" class="flex flex-col items-center gap-3 text-gray-300">
                            <i data-lucide="image" class="w-8 h-8 group-hover:text-primary-orange transition-colors"></i>
